...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Entry_t, stringdata) + ofs \
...
const QMetaObject Entry::staticMetaObject = {
    { &ComponentBase::staticMetaObject, qt_meta_stringdata_Entry.data,
      qt_meta_data_Entry,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Entry.stringdata))
