...
#include "../../cmdline/messagehandler.h"
...
QT_MOC_LITERAL(3, 25, 3)
    ...
    "MessageHandler\0debugMsg\0\0msg\0"
};
...
void MessageHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->debugMsg((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MessageHandler::debugMsg)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void MessageHandler::debugMsg(QString _t1)
{
