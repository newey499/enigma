...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_MySql_t, stringdata) + ofs \
...
const QMetaObject MySql::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_MySql.data,
      qt_meta_data_MySql,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_MySql.stringdata))
